...
import { getPostCards, getPosts, paginate } from "@/lib/content";
...
export default async function PaginatedPage({ params }: Params) {
  ...
  const { items, totalPages: total } = paginate(getPostCards(), current, site.postsPerPage);
