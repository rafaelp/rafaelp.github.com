<?php get_header(); ?>
		...
		<div id="content">
			...
			<?php if (is_category()) { ?>
            	...
            	<h2 class="result_heading"><?php _e('Arquivo',woothemes); ?> | <?php echo single_cat_title(); ?></h2>        
           	
				<?php } elseif (is_day()) { ?>
				<h2 class="result_heading"><?php _e('Arquivo',woothemes); ?> | <?php the_time('F jS, Y'); ?></h2>

				<?php } elseif (is_month()) { ?>
				<h2 class="result_heading"><?php _e('Arquivo',woothemes); ?> | <?php the_time('F, Y'); ?></h2>

				<?php } elseif (is_year()) { ?>
				<h2 class="result_heading"><?php _e('Arquivo',woothemes); ?> | <?php the_time('Y'); ?></h2>
