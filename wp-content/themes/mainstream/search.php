<?php get_header(); ?>
		...
		<div id="content">
			...
			<h2 class="result_heading"><?php _e('Resultado da busca por',woothemes); ?> "<?php printf(__('\'%s\''), $s) ?>"</h2>
			...
			<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
				...
				<div class="post">
					...
					<div class="entry">
						...
						<p><a class="more-link" href="<?php the_permalink(); ?>" title="Read the full entry"><?php _e('Continuar Lendo',woothemes); ?></a></p>
