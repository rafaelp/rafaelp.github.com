<?php get_header(); ?>
		...
		<div id="content">
			...
			<h2 class="result_heading">Posts com a Tag: <?php UTW_ShowCurrentTagSet('tagsetcommalist') ?></h2>
			...
			<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
				...
				<div class="post">
					...
					<div class="entry">
						...
						<p><a class="more-link" href="<?php the_permalink(); ?>" title="<?php _e('Ler o post completo',woothemes); ?>"><?php _e('Continuar Lendo',woothemes); ?></a></p>
